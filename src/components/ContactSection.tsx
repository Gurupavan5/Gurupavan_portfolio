...
const ContactSection: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/g-v-s-p-kumar-appisetti-b6a70829a",
      icon: <FaLinkedin size={20} />,
    },
    {
      name: "GitHub",
      url: "https://github.com/Gurupavan5",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8">
              Whether you have a question, project proposal, or just want to
              connect, my inbox is always open. I'll try my best to get back to
            ...
            <div
              className={`mt-10 space-y-4 transition-all duration-1000 delay-500 ${
