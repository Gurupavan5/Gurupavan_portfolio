        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              I'm a passionate creative professional with a knack for turning
              ideas into reality. When I'm not coding or designing, you'll find
              me hunting for the perfect meal 🍛 or convincing my cat 😺 that my
              keyboard is not a bed.
            </p>

            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              My coding journey started long ago as a curious dreamer with a
              laptop full of unfinished projects. Since then, I’ve been
              passionately building apps, experimenting with ideas, and turning
              countless coffee-fueled nights into working code. With over 4
              years of experience, I’ve taken the lead in creating digital
              experiences that solve real-world problems and delight
              users—combining creativity with functionality. Each project brings
              me closer to becoming a developer who crafts not just software,
